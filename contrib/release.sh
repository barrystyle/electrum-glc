...
# - WWW_DIR: path to "electrum-glc-web" git clone
#
...
# - update locale:
#     1. cd /opt/electrum-glc-locale && ./update && push
...
# create tarball
tarball="Electrum-GLC-$VERSION.tar.gz"
...
srctarball="Electrum-GLC-sourceonly-$VERSION.tar.gz"
...
# appimage
appimage="electrum-glc-$REV-x86_64.AppImage"
...
# windows
win1="electrum-glc-$REV.exe"
win2="electrum-glc-$REV-portable.exe"
win3="electrum-glc-$REV-setup.exe"
...
# android
apk1="Electrum-GLC-$VERSION.0-armeabi-v7a-release.apk"
apk1_unsigned="Electrum-GLC-$VERSION.0-armeabi-v7a-release-unsigned.apk"
apk2="Electrum-GLC-$VERSION.0-arm64-v8a-release.apk"
apk2_unsigned="Electrum-GLC-$VERSION.0-arm64-v8a-release-unsigned.apk"
