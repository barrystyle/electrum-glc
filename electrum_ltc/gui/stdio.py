...
class ElectrumGui(BaseElectrumGui, EventListener):
    ...
    def do_send(self):
        if not is_address(self.str_recipient):
            print(_('Invalid Goldcoin address'))
            return
        try:
    ...
    def network_dialog(self):
        print("use 'electrum-glc setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electrum-glc setconfig' to change your settings")
        return True
