...
WizardComponent {
    ...
    ColumnLayout {
        ...
        Label { text: qsTr('Import Goldcoin Addresses') }

        InfoTextArea {
            Layout.preferredWidth: parent.width
            text: qsTr('Enter a list of Goldcoin addresses (this will create a watching-only wallet), or a list of private keys.')
        }
