# Electrum-GLC - Lightweight Litecoin client
...
Language: Python (>= 3.8)
Homepage: https://electrum-glc.org/
```


## Getting started

_(If you've come here looking to simply run Electrum-GLC,
[you may download it here](https://electrum-glc.org/#download).)_
...
```
$ git clone https://github.com/pooler/electrum-glc.git
$ cd electrum-glc
...
Besides [GitHub](https://github.com/pooler/electrum-glc),
most communication about Electrum-GLC development happens on IRC, in the
`#electrum-glc` channel on Libera Chat. The easiest way to participate on IRC is
with the web client, [web.libera.chat](https://web.libera.chat/#electrum-glc).
